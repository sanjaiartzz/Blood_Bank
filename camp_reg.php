...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO camps (organization_type, organization_name, organizer_name, organizer_mobile, organizer_email, co_organizer_name, co_organizer_mobile, camp_name, camp_address, state, district, city, blood_bank, camp_propose_date, start_time, end_time, estimated_participants, username, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    
    $stmt = $conn->prepare($sql);
    $stmt->bind_param("sssssssssssssssssss", $_POST['organization_type'], $_POST['organization_name'], $_POST['organizer_name'], $_POST['organizer_mobile'], $_POST['organizer_email'], $_POST['co_organizer_name'], $_POST['co_organizer_mobile'], $_POST['camp_name'], $_POST['camp_address'], $_POST['state'], $_POST['district'], $_POST['city'], $_POST['blood_bank'], $_POST['camp_propose_date'], $_POST['start_time'], $_POST['end_time'], $_POST['estimated_participants'], $_POST['username'], $password_hashed);
